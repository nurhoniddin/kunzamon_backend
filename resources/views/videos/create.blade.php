                                ...
                                <form action="{{ route('videos.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="uz" role="tabpanel"
                                            ...
                                            <input type="text" name="title_uz" class="form-control" placeholder="video nomi">
                                            <hr>
                                            <input type="text" name="video_link_uz" class="form-control" placeholder="video link">
                                            <hr>
                                        ...
                                        <div class="tab-pane fade" id="kiril" role="tabpanel"
                                            ...
                                            <input type="text" name="title_cyril" class="form-control" placeholder="video nomi">
                                            <hr>
                                            <input type="text" name="video_link_cyril" class="form-control" placeholder="video link">
                                            <hr>
                                            <label for="video">video</label>
                                        ...
                                        <div class="tab-pane fade" id="ru" role="tabpanel"
                                            ...
                                            <input type="text" name="title_ru" class="form-control" placeholder="video nomi">
                                            <hr>
                                            <input type="text" name="video_link_ru" class="form-control" placeholder="video link">
                                            <hr>
                                            <label for="video">video</label>
                                        ...
                                        <div class="tab-pane fade" id="en" role="tabpanel"
                                             aria-labelledby="contact-tab">
                                            <input type="text" name="title_en" class="form-control" placeholder="video nomi">
                                            <hr>
                                            <input type="text" name="video_link_en" class="form-control" placeholder="video link">
                                            <hr>
                                            <label for="video">video</label>
